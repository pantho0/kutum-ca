...
const Contact = () => {
  ...
  return (
    <section ref={container} className="text-primary py-20 md:py-28">
            ...
            <form className="space-y-8">
              ...
              <div className="relative contact-form-field">
                <Input
                  type="text"
                  placeholder="Name"
                  className="pl-4 pr-12 py-7 bg-transparent border-0 border-b border-gray-500 rounded-none focus:ring-0 focus:border-primary placeholder:text-secondary text-lg"
                />
              ...
              <div className="relative contact-form-field">
                <Textarea
                  placeholder="Message"
                  className="pl-4 pr-12 py-7 bg-transparent border-0 border-b border-gray-500 rounded-none focus:ring-0 focus:border-primary placeholder:text-secondary text-lg min-h-[120px]"
                />
              ...
              <div className="pt-4 contact-form-field">
                <Button
                  type="submit"
                  className="bg-primary text-white px-10 py-7 text-base hover:bg-primary/80 hover:border hover:text-white cursor-pointer w-full sm:w-auto"
                >
                  Send Your Message
                </Button>
              </div>
